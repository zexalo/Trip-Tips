...
const PreviewRecomandation: React.FC<RecomandationProps> = ({title, content, id, isInUserFavorite, globalRating, city, country, picture, price}) => {
            ...
            <CardActions>
                <Link
                    to={{
                        ...
                        state: {title: title, content: content, id: id, isInUserFavorite: isInUserFavoriteLocal, globalRating: globalRating, city: city, country: country, picture: picture, price: price},
                }}
                >
