  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="backofficeApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="currencyLabel" for="country-currency">
                  Currency
                </Label>
                <AvField
                  id="country-currency"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="country-description">
                  Description
                </Label>
                <AvField id="country-description" data-cy="description" type="text" name="description" />
              </AvGroup>
