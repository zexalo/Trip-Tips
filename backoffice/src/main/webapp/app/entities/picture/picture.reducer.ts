...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_PICTURE: 'picture/PARTIAL_UPDATE_PICTURE',
...
export default (state: PictureState = initialState, action): PictureState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PICTURE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PICTURE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PICTURE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IPicture> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_PICTURE,
