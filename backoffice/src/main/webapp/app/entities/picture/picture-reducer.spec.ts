...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PICTURE),
          REQUEST(ACTION_TYPES.UPDATE_PICTURE),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PICTURE),
          REQUEST(ACTION_TYPES.DELETE_PICTURE),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PICTURE),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PICTURE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PICTURE),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PICTURE),
          payload: resolvedObject,
        },
      ];
